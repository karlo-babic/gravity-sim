...
int main(int argc, char *argv[])
{
  ...
  QString configFileName1 = makeGroupLoad(sim.loadBox, "konfiguracija");
  ...
  makeGroupSpin(sim.scaleBox, "velicina", 1, 30, scale);
  sim.borderBox = new QGroupBox;
  makeGroupCheck(sim.borderBox, "rub", border);
  sim.sizeOfSunBox = new QGroupBox;
  makeGroupSpinDouble(sim.sizeOfSunBox, "velicina sunca", 0.01, 30, sizeOfSun);
  ...
  makeGroupSpin(sim.avgSizeOfObjectsBox, "prosjecna velicina objekata", 1, 30, avgSizeOfObjects);
  sim.objectPreviewSizeBox = new QGroupBox;
  makeGroupSpin(sim.objectPreviewSizeBox, "velicina prikazanih objekata", 1, 30, objectPreviewSize);
  sim.initialSpinBox = new QGroupBox;
  makeGroupSpin(sim.initialSpinBox, "pocetna rotacija", 0, 30, initialSpin);
  ...
  makeGroupSpin(sim.traceBox, "trag", 0, 30, trace);
